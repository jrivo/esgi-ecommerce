 ...
 */
final class Version20220914144233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, discount INT DEFAULT NULL, total DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE order_product (id INT NOT NULL, product_id INT DEFAULT NULL, ordered_id INT DEFAULT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2530ADE64584665A ON order_product (product_id)');
        $this->addSql('CREATE INDEX IDX_2530ADE6AA60395A ON order_product (ordered_id)');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, description TEXT NOT NULL, nutri_score VARCHAR(1) NOT NULL, stock INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE order_product ADD CONSTRAINT FK_2530ADE6AA60395A FOREIGN KEY (ordered_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_product DROP CONSTRAINT FK_2530ADE6AA60395A');
